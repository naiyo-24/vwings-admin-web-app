...
const AboutUs = () => {
  return (
    ...
    >
      {/* Hero Section */}
      <motion.div variants={itemVariants} style={{ position: 'relative', overflow: 'hidden', borderRadius: '32px', padding: '60px 40px', background: 'linear-gradient(135deg, rgba(30, 27, 75, 0.8) 0%, rgba(88, 28, 135, 0.6) 100%)', border: '1px solid rgba(255, 255, 255, 0.1)', boxShadow: '0 20px 40px rgba(0,0,0,0.3)', textAlign: 'center' }}>
